import React, { Fragment, Component as Component$1 } from 'react';
import PropTypes, { string, array, object, bool } from 'prop-types';
import classnames from 'classnames';
import { ReactSVG } from 'react-svg';
import { isMobile } from 'react-device-detect';
import { ExclamationCircleFilled, CheckOutlined, PaperClipOutlined, EditFilled, CopyOutlined } from '@ant-design/icons';
...
var Editable = function Editable(_ref) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: classnames('edit-wrapper__container', {
      reverse: reverse
    }),
    style: style
    ...
    style: triggerStyles
  }, stringId && /*#__PURE__*/React.createElement("div", {
    className: "edit-wrapper__icon-wrapper",
    "data-string-id": stringId
  }, /*#__PURE__*/React.createElement(EditStringSvg, null)), iconId && /*#__PURE__*/React.createElement("div", {
    className: "edit-wrapper__icon-wrapper",
    "data-icon-id": iconId
  }, /*#__PURE__*/React.createElement(EditIconSvg, null)), backgroundId && /*#__PURE__*/React.createElement("div", {
    className: "edit-wrapper__icon-wrapper",
    "data-icon-id": backgroundId
  }, /*#__PURE__*/React.createElement(EditBackgroundSVG, null)), sectionId && /*#__PURE__*/React.createElement("div", {
    className: "edit-wrapper__icon-wrapper large",
    "data-section-id": sectionId
  }, /*#__PURE__*/React.createElement(EditSettingsSvg, null))));
};
Editable.propTypes = {
  stringId: string,
  iconId: string,
...
var Button = function Button(_ref) {
  ...
  return /*#__PURE__*/React.createElement(Fragment, null, stringId && /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(Editable, {
    stringId: stringId
  })), /*#__PURE__*/React.createElement("button", {
    type: type,
    onClick: onClick,
    className: classnames('holla-button', 'mdc-button', 'mdc-button--unelevated', 'holla-button-font', {
      disabled: disabled
    }, className),
    disabled: disabled,
    autoFocus: autoFocus
...
var Image = function Image(_ref) {
  ...
  if (isBackground) {
    return /*#__PURE__*/React.createElement("div", {
      className: classnames(wrapperClassName, 'background-size-contain', 'h-100'),
      style: {
  ...
  return /*#__PURE__*/React.createElement(Editable, {
    ...
    stringId: stringId
  }, icon && useSvg && /*#__PURE__*/React.createElement(ReactSVG, {
    src: icon,
  ...
  }), icon && !useSvg && /*#__PURE__*/React.createElement("img", {
    src: icon,
    alt: alt,
    className: classnames(wrapperClassName, imageWrapperClassName, 'object-fit-contain')
  }));
};
Image.defaultProps = {
  icon: '',
...
var PanelInformationRow = function PanelInformationRow(_ref) {
  ...
  }, bold ? /*#__PURE__*/React.createElement("b", null, label) : label, ":", ' ', /*#__PURE__*/React.createElement("span", null, information)), stringId && /*#__PURE__*/React.createElement(Editable, {
    stringId: stringId
  }));
};
...
var ActionNotification = function ActionNotification(_ref) {
  ...
  }, (showActionText || !isMobile) && /*#__PURE__*/React.createElement("div", {
    className: classnames('action_notification-text', getClassNames(status))
  }, text), iconPath && /*#__PURE__*/React.createElement(Image, {
    iconId: iconId,
    stringId: stringId,
    icon: iconPath,
    alt: text,
...
var BasicIconTitle = function BasicIconTitle(_ref) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: classnames('icon_title-wrapper', {
      underline: underline
    }, className)
  }, iconPath && /*#__PURE__*/React.createElement(Image, {
    iconId: iconId,
    icon: iconPath,
    alt: text,
    ...
    className: classnames('icon_title-text', 'text-center', textType)
  }, text)));
};
var EnhancedIconTitle = function EnhancedIconTitle(_ref2) {
  ...
  }, /*#__PURE__*/React.createElement(BasicIconTitle, rest), /*#__PURE__*/React.createElement("div", {
    className: classnames('d-flex', 'justify-content-between', 'p-relative')
  }, /*#__PURE__*/React.createElement("div", {
    className: "font-weight-bold font-small"
  }, subtitle), /*#__PURE__*/React.createElement("div", null, actionProps && /*#__PURE__*/React.createElement(ActionNotification, actionProps))));
};
var IconTitle = function IconTitle(props) {
  if (props.subtitle || props.actionProps) {
    return /*#__PURE__*/React.createElement(EnhancedIconTitle, props);
  }
  return /*#__PURE__*/React.createElement(BasicIconTitle, props);
};
...
var FieldContent = function FieldContent(_ref) {
  ...
  }, label, warning && /*#__PURE__*/React.createElement("div", {
  ...
  }, warning))), /*#__PURE__*/React.createElement(Editable, {
    stringId: stringId
  })), /*#__PURE__*/React.createElement("div", {
    className: classnames('field-content')
  }, /*#__PURE__*/React.createElement("div", {
    className: classnames('field-children', {
      valid: valid,
      custom: hideUnderline
    }, contentClassName, {
      'input-box-field': ishorizontalfield && dateFieldClassName === ''
    })
  }, children, !hideCheck && valid && hasValue && /*#__PURE__*/React.createElement(CheckOutlined, {
    className: "field-valid"
  })), !hideUnderline && /*#__PURE__*/React.createElement("span", {
    className: classnames('field-content-outline', outlineClassName, {
      focused: focused
    })
  }))), /*#__PURE__*/React.createElement("div", {
    className: "field-label-wrapper"
  }, ishorizontalfield ? /*#__PURE__*/React.createElement(Fragment, null, /*#__PURE__*/React.createElement("div", {
    className: "field-label"
...
var FieldError = function FieldError(_ref2) {
  ...
  }, error && /*#__PURE__*/React.createElement(Editable, {
    stringId: stringId
  }, /*#__PURE__*/React.createElement(ExclamationCircleFilled, {
    className: "field_warning_icon"
  }), /*#__PURE__*/React.createElement("span", {
    className: "field-error-text"
  }, getErrorLocalized(error))), preview && /*#__PURE__*/React.createElement(Fragment, null, preview));
};
  ...
  _createClass$1(FieldWrapper, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React.createElement("div", {
        ...
        preview: preview,
        getErrorLocalized: getErrorLocalized
      }, children, notification && _typeof(notification) === 'object' && /*#__PURE__*/React.createElement(ActionNotification, _extends$1({}, notification, {
        className: classnames('pr-0 pl-0 no_bottom', {
          'with-tick-icon': fullWidth && !invalid && !hideCheck
        }),
        showActionText: true
      }))), !ishorizontalfield ? /*#__PURE__*/React.createElement(FieldError, {
        displayError: displayError,
        error: error,
        preview: preview,
        getErrorLocalized: getErrorLocalized
...
var InputField$1 = function InputField(props) {
  ...
  return /*#__PURE__*/React.createElement(FieldWrapper, props, /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex'
    }
  }, options && renderIcon(options), /*#__PURE__*/React.createElement("input", _extends$1({
...
var TextAreaField = function TextAreaField(props) {
  ...
  var displayError = touched && error && !active;
  // const displayCheck = !fullWidth && input.value && !displayError && !active;
  return /*#__PURE__*/React.createElement(FieldWrapper, props, /*#__PURE__*/React.createElement("textarea", _extends$1({
    rows: rows ? rows : '1',
    placeholder: placeholder,
    className: classnames('input_field-input', {
      error: displayError
...
var FileField = /*#__PURE__*/function (_Component) {
  ...
  _createClass$1(FileField, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React.createElement(FieldWrapper, _extends$1({}, this.props, {
      ...
      }, filename ? filename : placeholder), multiple ? fileArray.length !== length && multiple && /*#__PURE__*/React.createElement(ActionNotification, {
        stringId: "ADD_FILES",
        text: STRINGS['ADD_FILES'] || 'ADD_FILES',
        status: "information",
        icon: /*#__PURE__*/React.createElement(PaperClipOutlined, null),
        className: "no_bottom pr-0 pl-0 paper-clip-icon"
      }) : !filename && /*#__PURE__*/React.createElement(ActionNotification, {
        stringId: "ADD_FILES",
        text: STRINGS['ADD_FILES'] || 'ADD_FILES',
        status: "information",
        icon: /*#__PURE__*/React.createElement(PaperClipOutlined, null),
...
var DropdownField = /*#__PURE__*/function (_Component) {
  ...
  function DropdownField() {
    ...
    _defineProperty(_assertThisInitialized(_this), "renderIcon", function (_ref) {
      ...
      if (icon && typeof icon === 'string') {
        return icon.indexOf('.svg') > 0 ? /*#__PURE__*/React.createElement(ReactSVG, {
          src: icon,
          fallback: function fallback() {
  ...
  _createClass$1(DropdownField, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React.createElement(FieldWrapper, _extends$1({}, this.props, {
      ...
      }), autocomplete && isOpen && /*#__PURE__*/React.createElement(EventListener, {
        target: "document",
      ...
      }, autocomplete && /*#__PURE__*/React.createElement("input", {
        ...
        value: filter
      }), selectedItem && !isOpen ? this.renderOption(selectedItem) : /*#__PURE__*/React.createElement("div", {
...
var InputField = function InputField(props) {
  ...
  return /*#__PURE__*/React.createElement(FieldWrapper, _extends$1({
    hideUnderline: true,
    className: classnames('checkfield-wrapper', 'd-flex', 'flex-column'),
    type: type
  }, rest), /*#__PURE__*/React.createElement("div", {
    className: classnames('checkfield-input-wrapper', 'd-flex', reverse ? 'flex-row-reverse' : '')
  }, /*#__PURE__*/React.createElement("input", _extends$1({
    type: type
  }, input, {
...
var EditableInputField = /*#__PURE__*/function (_Component) {
  ...
  _createClass$1(EditableInputField, [{
    ...
    value: function render() {
      ...
      })), /*#__PURE__*/React.createElement(ActionNotification, {
        stringId: "EDIT_TEXT",
        text: STRINGS['EDIT_TEXT'] || 'Edit',
        status: "information",
        icon: /*#__PURE__*/React.createElement(EditFilled, null),
...
var CaptchaField = /*#__PURE__*/function (_Component) {
  ...
  _createClass$1(CaptchaField, [{
    ...
    value: function render() {
      ...
      }, /*#__PURE__*/React.createElement(dist.ReCaptcha, {
        ref: this.setRef,
...
var DumbField = function DumbField(_ref) {
  ...
  }, copyOnClick ? /*#__PURE__*/React.createElement(lib.CopyToClipboard, {
    text: value
  }, /*#__PURE__*/React.createElement("div", {
...
export { ActionNotification, Button, Editable, IconTitle, Image, PanelInformationRow, getFormFieldComponentByType };
